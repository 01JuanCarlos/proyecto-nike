...
function cuerpo(){
    ...
    let items=document.getElementsByClassName("blok");
    for(let i=0; i<items.length; i++)
    {
        items[i].setAttribute("style",
        "background:black; border-radius:5px; transition:all ease 3s ");
    }
}
...
document.body.setAttribute("onload","fecha(), hora(), cuerpo()")
